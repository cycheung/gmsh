...
g++ -I $ONELAB_DIR -I $COMMON_DIR $COMMON_DIR/OS.cpp $COMMON_DIR/StringUtils.cpp $ONELAB_DIR/OnelabClients.cpp $ONELAB_DIR/OnelabMessage.cpp $ONELAB_DIR/OnelabParser.cpp $ONELAB_DIR/SOLVERS/onelab.cpp $ONELAB_DIR/loader.cpp -o onelab_loader
