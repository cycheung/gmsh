...
DefineConstant[ d = {0.02, Min 0.01, Max 0.05, Step 0.002,
    Name "Parameters/Geometry/Core width"} ] ;
DefineConstant[ l = {0.14, Min 0.05, Max 0.2, Step 0.01,
    Name "Parameters/Geometry/Core half-length"} ] ;
DefineConstant[ Val_Rint = {0.2, Min l, Max 50, Step 0.1,
    Name "Parameters/Geometry/1Internal shell radius"}];
DefineConstant[ Val_Rext = {0.3, Min Val_Rint, Max 50, Step 0.1,
