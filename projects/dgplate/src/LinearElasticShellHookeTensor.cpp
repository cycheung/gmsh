...
void LinearElasticShellHookeTensor::set(const LocalBasis *lb,const double &C11,const double &nu)
{
  for(int i=0;i<2;i++)
    for(int j=0;j<2;j++)
...
void LinearElasticShellHookeTensor::set(const LocalBasis *lb,const double &nu)
{
  for(int i=0;i<2;i++)
    for(int j=0;j<2;j++)
      for(int ii=0;ii<2;ii++)
...
void LinearElasticShellHookeTensor::hat(const LocalBasis *lb, const double C11, const double nu)
{
  double temp;
  for(int i=0;i<2;i++)
    for(int j=0;j<2;j++)
...
void LinearElasticShellHookeTensor::hat(const LocalBasis *lb,const LinearElasticShellHookeTensor *H)
{
  double temp;
  for(int i=0;i<2;i++)
    for(int j=0;j<2;j++)
